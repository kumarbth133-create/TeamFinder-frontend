  ...
  return (
    <MainLayout>
      <div className="max-w-2xl mx-auto space-y-6">
        <Link to="/students" className="flex items-center gap-2 text-sm text-slate-500 dark:text-gray-400 hover:text-primary-600 dark:hover:text-primary-400">
        ...
        <div className="card">
          <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6">
            ...
            <div className="text-center sm:text-left flex-1">
              ...
              {student.college && <p className="text-slate-600 dark:text-gray-400 text-sm mt-1">📍 {student.college}</p>}
              <div className="flex gap-3 mt-3 justify-center sm:justify-start">
                {student.githubLink && (
                  <a href={student.githubLink} target="_blank" rel="noopener noreferrer"
                    className="flex items-center gap-1 text-sm text-slate-500 dark:text-gray-400 hover:text-primary-600 dark:hover:text-primary-400">
                    <FiGithub /> GitHub
                  </a>
                )}
          ...
          {student.bio && (
            <div className="mt-6 pt-6 border-t border-slate-200 dark:border-dark-600">
              <h3 className="text-sm font-semibold text-slate-800 dark:text-gray-200 mb-2">About</h3>
              <p className="text-slate-600 dark:text-gray-300 text-sm leading-relaxed">{student.bio}</p>
            </div>
          )}

          {student.skills?.length > 0 && (
            <div className="mt-6 pt-6 border-t border-slate-200 dark:border-dark-600">
              <h3 className="text-sm font-semibold text-slate-800 dark:text-gray-200 mb-3">Skills</h3>
